...
if("TRUE" STREQUAL "TRUE")
  set(tuw_ellipses_SOURCE_PREFIX /home/dof6/catkin_ws/src/tuw_marker_detection-kinetic-devel/tuw_ellipses)
  set(tuw_ellipses_DEVEL_PREFIX /home/dof6/catkin_ws/devel)
  ...
  set(tuw_ellipses_INSTALL_PREFIX /home/dof6/catkin_ws/install)
...
if(NOT "/home/dof6/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tuw_ellipses' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dof6/catkin_ws/src/tuw_marker_detection-kinetic-devel/tuw_ellipses/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT tuw_ellipses_NUM_DUMMY_TARGETS)
      set(tuw_ellipses_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::tuw_ellipses::wrapped-linker-option${tuw_ellipses_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR tuw_ellipses_NUM_DUMMY_TARGETS "${tuw_ellipses_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::tuw_ellipses::wrapped-linker-option${tuw_ellipses_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND tuw_ellipses_LIBRARIES "${interface_target_name}")
